...
3. **載入現有規格**：將以下規格檔案載入記憶體：
   - `spec/erm-core.dbml`, `spec/erm-organization.dbml`, `spec/erm-classroom.dbml`, `spec/erm-subscription.dbml`, `spec/erm-content.dbml`
   - `spec/features/<domain>/*.feature`（依領域分資料夾）
   - 保持原始格式與結構,供後續增量更新使用
...
- **資料模型釐清** → 更新對應的 DBML 檔案（`spec/erm-core.dbml`, `spec/erm-organization.dbml`, `spec/erm-classroom.dbml`, `spec/erm-subscription.dbml`, `spec/erm-content.dbml`），依照 `formulation-rules.md` 的 DBML 格式規範
