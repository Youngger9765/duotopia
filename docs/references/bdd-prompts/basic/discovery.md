...
- **資料模型 (ERM) 相關**：`.clarify/data/<實體名>_<問題全句，以底線代替分隔符號>.md`
  ...
  - 例如：`.clarify/data/StudentItemProgress_學生朗讀分數多少為通過.md`
  - 例如：`.clarify/data/Classroom_教師離職時班級如何處理.md`
  - 例如：`.clarify/data/Student_學生同時屬於兩個機構時帳號密碼是否保持一組.md`
  - 例如：`.clarify/data/Student_學生是否可以屬於同一位老師的不同班級.md`

- **功能 (Feature) 相關**：`.clarify/features/<功能名>_<問題全句，以底線代替分隔符號>.md`
  - 例如：`.clarify/features/新增機構教材_所有等級教師是否都可新增.md`
  - 例如：`.clarify/features/提交朗讀作業_分數過低是否強制訂正.md`
