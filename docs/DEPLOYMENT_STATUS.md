...
### 部署遷移前後對比
| 環境 | 舊方案 (VM) | 新方案 (Cloud Run) | 節省金額 | 節省比例 |
|------|------------|-------------------|---------|---------|
| Production | $13/月（固定） | $5-10/月（Scale-to-Zero） | ~$3-8/月 | 23-62% |
| Staging | N/A | $0-5/月（Scale-to-Zero） | N/A | N/A |
| Per-Issue Preview | N/A | $0-5/月（Auto-cleanup） | N/A | N/A |
| **總計** | **$13/月** | **$5-15/月** | **平均 ~$5/月** | **~38% 節省** |

### 成本優化亮點
- ✅ **Production**: VM → Cloud Run，減少 $3-8/月
- ✅ **Staging**: Scale-to-Zero，無流量時 $0
- ✅ **Per-Issue**: 自動清理，避免資源堆積
- ✅ **總體**: 月均節省約 38%，年節省 ~$60

### 遷移完成時間表
- **2025-12-10**: Production 遷移至 Cloud Run 完成
- **2025-12-24** (預計): 關閉 VM，成本節省完全實現
