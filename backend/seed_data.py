...
def seed_sentence_making_course(db: Session, classroom_id: int, teacher_id: int):
    ...
    # 第一個練習的單字 (20個)
    words_set1_1 = [
        ("school", "學校", "I go to school every day.", "我每天都去上學。"),
        ("classroom", "教室", "Our classroom is very clean.", "我們的教室很乾淨。"),
        ("teacher", "老師", "My teacher is very kind.", "我的老師很親切。"),
        ("student", "學生", "She is a good student.", "她是一位好學生。"),
        ("desk", "書桌", "There is a book on the desk.", "書桌上有一本書。"),
        ("chair", "椅子", "Please sit on the chair.", "請坐在椅子上。"),
        ("board", "黑板", "The teacher writes on the board.", "老師在黑板上寫字。"),
        ("book", "書", "I like reading books.", "我喜歡看書。"),
        ("pencil", "鉛筆", "I need a pencil to write.", "我需要一支鉛筆來寫字。"),
        ("eraser", "橡皮擦", "Can I borrow your eraser?", "我可以借你的橡皮擦嗎？"),
        ("ruler", "尺", "Use a ruler to draw a straight line.", "用尺畫一條直線。"),
        ("bag", "書包", "My bag is very heavy.", "我的書包很重。"),
        ("library", "圖書館", "We study in the library.", "我們在圖書館讀書。"),
        ("playground", "操場", "Students play on the playground.", "學生們在操場上玩。"),
        ("lunch", "午餐", "What do you have for lunch?", "你午餐吃什麼？"),
        ("homework", "作業", "I do my homework every day.", "我每天做作業。"),
        ("test", "考試", "We have a test tomorrow.", "我們明天有考試。"),
        ("subject", "科目", "Math is my favorite subject.", "數學是我最喜歡的科目。"),
        ("lesson", "課程", "The English lesson is interesting.", "英文課很有趣。"),
    ...
    # 第二個練習的單字 (22個)
    words_set1_2 = [
        ("learn", "學習", "I learn English at school.", "我在學校學英文。"),
        ("study", "研讀", "We study hard for exams.", "我們為了考試努力讀書。"),
        ("read", "閱讀", "I read a book every night.", "我每晚讀一本書。"),
        ("write", "寫", "Please write your name here.", "請在這裡寫下你的名字。"),
        ("listen", "聽", "Listen to the teacher carefully.", "仔細聽老師說。"),
        ("speak", "說", "Can you speak English?", "你會說英文嗎？"),
        ("practice", "練習", "Practice makes perfect.", "熟能生巧。"),
        ("remember", "記得", "I remember what you said.", "我記得你說的話。"),
        ("understand", "理解", "Do you understand this question?", "你理解這個問題嗎？"),
        ("notebook", "筆記本", "I write notes in my notebook.", "我在筆記本上寫筆記。"),
        ("pen", "鋼筆", "I write with a blue pen.", "我用藍色的鋼筆寫字。"),
        ("marker", "麥克筆", "Use a marker to highlight important parts.", "用麥克筆標記重要部分。"),
        ...
        ("backpack", "背包", "My backpack is full of books.", "我的背包裝滿了書。"),
        ("locker", "置物櫃", "I keep my things in my locker.", "我把東西放在置物櫃裡。"),
    ...
    # 第三個練習的單字 (23個)
    words_set2_1 = [
        ("family", "家庭", "I love my family.", "我愛我的家人。"),
        ("father", "父親", "My father works in an office.", "我的父親在辦公室工作。"),
        ("mother", "母親", "My mother cooks delicious food.", "我的母親做美味的食物。"),
        ("brother", "兄弟", "I have one younger brother.", "我有一個弟弟。"),
        ("sister", "姊妹", "My sister is in high school.", "我的姊姊在念高中。"),
        ("grandma", "奶奶/外婆", "My grandma tells me stories.", "我的奶奶給我講故事。"),
        ("grandpa", "爺爺/外公", "My grandpa likes gardening.", "我的爺爺喜歡園藝。"),
        ("parent", "父母", "My parents are very caring.", "我的父母很關心我。"),
        ("home", "家", "I go home after school.", "我放學後回家。"),
        ("house", "房子", "We live in a big house.", "我們住在一棟大房子裡。"),
        ("room", "房間", "My room is tidy.", "我的房間很整潔。"),
        ("bedroom", "臥室", "I sleep in my bedroom.", "我在臥室睡覺。"),
        ("kitchen", "廚房", "Mom is cooking in the kitchen.", "媽媽在廚房煮飯。"),
        ("bathroom", "浴室", "I brush my teeth in the bathroom.", "我在浴室刷牙。"),
        ("living room", "客廳", "We watch TV in the living room.", "我們在客廳看電視。"),
        ("dining room", "餐廳", "We eat dinner in the dining room.", "我們在餐廳吃晚餐。"),
        ("window", "窗戶", "Please open the window.", "請打開窗戶。"),
        ("door", "門", "Close the door, please.", "請關上門。"),
        ("bed", "床", "I make my bed every morning.", "我每天早上整理床鋪。"),
        ("table", "桌子", "Put the dishes on the table.", "把盤子放在桌上。"),
        ("sofa", "沙發", "We sit on the sofa and relax.", "我們坐在沙發上放鬆。"),
        ("lamp", "檯燈", "Turn on the lamp, please.", "請打開檯燈。"),
    ...
    # 第四個練習的單字 (25個)
    words_set2_2 = [
        ("wake up", "起床", "I wake up at 7 o'clock.", "我七點起床。"),
        ("get up", "起來", "Please get up now.", "請現在起來。"),
        ("brush", "刷", "I brush my teeth twice a day.", "我一天刷兩次牙。"),
        ("wash", "洗", "Wash your hands before eating.", "吃飯前洗手。"),
        ("eat", "吃", "What do you eat for breakfast?", "你早餐吃什麼？"),
        ("drink", "喝", "I drink milk every morning.", "我每天早上喝牛奶。"),
        ("breakfast", "早餐", "Breakfast is the most important meal.", "早餐是最重要的一餐。"),
        ("dinner", "晚餐", "We have dinner at 6 PM.", "我們下午六點吃晚餐。"),
        ("cook", "煮飯", "My mom cooks very well.", "我媽媽煮飯很好吃。"),
        ("clean", "打掃", "I clean my room every week.", "我每週打掃房間。"),
        ("watch", "看", "I watch TV after dinner.", "我晚餐後看電視。"),
        ("play", "玩", "Children play in the park.", "孩子們在公園玩。"),
        ("sleep", "睡覺", "I sleep for eight hours.", "我睡八個小時。"),
        ("morning", "早上", "Good morning!", "早安！"),
        ("afternoon", "下午", "See you this afternoon.", "下午見。"),
        ("evening", "傍晚", "We go for a walk in the evening.", "我們傍晚去散步。"),
        ("night", "夜晚", "Good night, sleep well.", "晚安，睡個好覺。"),
        ("today", "今天", "What day is today?", "今天星期幾？"),
        ("tomorrow", "明天", "I will see you tomorrow.", "我明天會見你。"),
        ("yesterday", "昨天", "Yesterday was Monday.", "昨天是星期一。"),
        ("weekend", "週末", "I relax on the weekend.", "我週末放鬆。"),
        ("busy", "忙碌", "My parents are very busy.", "我的父母很忙。"),
        ("free", "有空的", "Are you free this afternoon?", "你今天下午有空嗎？"),
        ("tired", "累的", "I feel tired after school.", "我放學後覺得累。"),
    ...
    db.commit()
    print(
        f"✅ 句子模組課程建立完成：2 單元，4 個練習，共 {len(words_set1_1) + len(words_set1_2) + len(words_set2_1) + len(words_set2_2)} 個單字"
    )
