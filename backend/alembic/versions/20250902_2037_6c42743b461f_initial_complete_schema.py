...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum("READING_ASSESSMENT", name="contenttype"), nullable=True),
        sa.Column("title", sa.String(length=200), nullable=False),
        sa.Column("order_index", sa.Integer(), nullable=True),
        sa.Column("is_active", sa.Boolean(), nullable=True),
    ...
    op.create_index(op.f("ix_assignment_contents_id"), "assignment_contents", ["id"], unique=False)
    op.create_table(
        "student_assignments",
        sa.Column("id", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_student_content_progress_id"), table_name="student_content_progress")
