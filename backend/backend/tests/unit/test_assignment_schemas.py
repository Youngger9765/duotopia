...
class TestAssignmentCreateSchema:
    ...
    def test_assignment_create_validation_errors(self):
        ...
        # Empty content_ids
        with pytest.raises(ValidationError) as exc_info:
            AssignmentCreate(title="Test", classroom_id=1, content_ids=[], student_ids=[])
    ...
    def test_assignment_create_type_validation(self):
        ...
        with pytest.raises(ValidationError):
            AssignmentCreate(title="Test", classroom_id="not_an_int", content_ids=[1], student_ids=[])

        # Invalid content_ids type
        with pytest.raises(ValidationError):
            AssignmentCreate(title="Test", classroom_id=1, content_ids="not_a_list", student_ids=[])
