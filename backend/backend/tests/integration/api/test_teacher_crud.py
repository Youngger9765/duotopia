...
class TeacherCRUDTest:
    ...
    def test_classroom_crud(self):
        ...
        response = requests.get(f"{BASE_URL}/api/teachers/classrooms/{classroom_id}", headers=self.headers())
        if response.status_code == 200:
            classroom = response.json()
        ...
        response = requests.delete(f"{BASE_URL}/api/teachers/classrooms/{classroom_id}", headers=self.headers())
        if response.status_code == 200:
    ...
    def test_student_crud(self):
        ...
        response = requests.get(f"{BASE_URL}/api/teachers/students/{student_id}", headers=self.headers())
        if response.status_code == 200:
            student = response.json()
        ...
        response = requests.delete(f"{BASE_URL}/api/teachers/students/{student_id}", headers=self.headers())
        if response.status_code == 200:
        ...
        requests.delete(f"{BASE_URL}/api/teachers/classrooms/{classroom_id}", headers=self.headers())
    ...
    def test_program_crud(self):
        ...
        response = requests.get(f"{BASE_URL}/api/teachers/programs/{program_id}", headers=self.headers())
        if response.status_code == 200:
            program = response.json()
        ...
        response = requests.delete(f"{BASE_URL}/api/teachers/programs/{program_id}", headers=self.headers())
        if response.status_code == 200:
