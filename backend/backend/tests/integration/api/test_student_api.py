...
class TestStudentAPI:
    ...
    def test_get_assignments(self) -> list:
        ...
        response = requests.get(f"{self.base_url}/api/students/assignments", headers=self.headers)
    ...
    def test_student_profile(self) -> Dict[str, Any]:
        ...
        response = requests.get(f"{self.base_url}/api/students/profile", headers=self.headers)
