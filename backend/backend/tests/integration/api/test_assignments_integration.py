...
class TestAssignmentsIntegration:
    ...
    def test_teacher_login(self):
        """測試教師登入"""
        response = self.session.post(f"{self.BASE_URL}/auth/teacher/login", json=self.TEACHER_CREDS)
    ...
    def test_get_classroom_students(self):
        ...
        response = self.session.get(f"{self.BASE_URL}/classrooms/{self.classroom_id}/students")
    ...
    def test_get_contents(self):
        ...
        response = self.session.get(f"{self.BASE_URL}/contents", params={"classroom_id": self.classroom_id})
    ...
    def test_student_view_assignment_detail(self):
        ...
        response = requests.get(f"{self.BASE_URL}/assignments/{self.assignment_id}/detail", headers=headers)
