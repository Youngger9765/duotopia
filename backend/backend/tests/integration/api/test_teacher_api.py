...
class TestTeacherAPI:
    ...
    def test_get_dashboard(self) -> Dict[str, Any]:
        ...
        response = requests.get(f"{self.base_url}/api/teachers/dashboard", headers=self.headers)
    ...
    def test_get_classrooms(self) -> list:
        ...
        response = requests.get(f"{self.base_url}/api/teachers/classrooms", headers=self.headers)
    ...
    def test_get_classroom_detail(self, classroom_id: int) -> Dict[str, Any]:
        ...
        if classroom.get("students"):
            ...
            for student in classroom["students"]:
                print(f"      - {student.get('name', 'Unknown')} (ID: {student.get('id')})")

        # 列出課程
        if classroom.get("programs"):
            print("\n   📚 課程列表:")
            for program in classroom["programs"]:
                print(f"      - {program.get('name', 'Unknown')} (ID: {program.get('id')})")
