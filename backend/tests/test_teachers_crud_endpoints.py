...
from models import (
    Teacher, Classroom, Student, ClassroomStudent, Program, 
    ProgramLevel
)
...
class TestClassroomListEndpoints:
    ...
    def test_get_classrooms_with_data(self, client, sample_classroom, crud_auth_headers):
...
class TestClassroomCRUD:
    ...
    def test_create_classroom_success(self, client, crud_auth_headers):
        ...
        response = client.post("/api/teachers/classrooms", json=classroom_data, headers=crud_auth_headers)
    ...
    def test_get_classroom_by_id(self, client, sample_classroom, crud_auth_headers):
        ...
        response = client.get(f"/api/teachers/classrooms/{sample_classroom.id}", headers=crud_auth_headers)
    ...
    def test_get_classroom_not_found(self, client, crud_auth_headers):
        ...
        response = client.get("/api/teachers/classrooms/99999", headers=crud_auth_headers)
    ...
    def test_get_classroom_wrong_teacher(self, client, sample_classroom, demo_teacher):
        ...
        response = client.get(f"/api/teachers/classrooms/{sample_classroom.id}", headers=headers)
        assert response.status_code == 404
    ...
    def test_update_classroom(self, client, sample_classroom, crud_auth_headers):
        ...
        response = client.put(f"/api/teachers/classrooms/{sample_classroom.id}", json=update_data, headers=crud_auth_headers)
    ...
    def test_update_classroom_partial(self, client, sample_classroom, crud_auth_headers):
    ...
    def test_delete_classroom(self, client, sample_classroom, crud_auth_headers):
        ...
        response = client.delete(f"/api/teachers/classrooms/{sample_classroom.id}", headers=crud_auth_headers)
        
        assert response.status_code == 200
        
        # Verify classroom is marked inactive (soft delete)
        get_response = client.get(f"/api/teachers/classrooms/{sample_classroom.id}", headers=crud_auth_headers)
...
class TestStudentCRUD:
    ...
    def test_create_student_success(self, client, crud_auth_headers):
        ...
        response = client.post("/api/teachers/students", json=student_data, headers=crud_auth_headers)
    ...
    def test_get_student_by_id(self, client, sample_student, crud_auth_headers):
        ...
        response = client.get(f"/api/teachers/students/{sample_student.id}", headers=crud_auth_headers)
    ...
    def test_update_student(self, client, sample_student, crud_auth_headers):
        ...
        update_data = {
            ...
            "student_id": "UPDATED01"
        }
        
        response = client.put(f"/api/teachers/students/{sample_student.id}", json=update_data, headers=crud_auth_headers)
    ...
    def test_delete_student(self, client, sample_student, crud_auth_headers):
        ...
        response = client.delete(f"/api/teachers/students/{sample_student.id}", headers=crud_auth_headers)
        
        assert response.status_code == 200
        
        # Verify student is marked inactive
        get_response = client.get(f"/api/teachers/students/{sample_student.id}", headers=crud_auth_headers)
        assert get_response.status_code == 404

class TestBatchStudentOperations:
    """Test batch student operations"""
    
    def test_batch_add_students_to_classroom(self, client, sample_classroom, crud_auth_headers):
        """Test adding multiple students to a classroom"""
        students_data = {
            "students": [
                {"name": "Batch Student 1", "birthdate": "2010-01-01", "student_id": "BATCH01"},
                {"name": "Batch Student 2", "birthdate": "2010-02-02", "student_id": "BATCH02"},
        ...
        classroom_response = client.get(f"/api/teachers/classrooms/{sample_classroom.id}", headers=crud_auth_headers)
        classroom_data = classroom_response.json()
        assert len(classroom_data["students"]) == 3
        
    def test_batch_add_students_duplicate_handling(self, client, sample_classroom, sample_student, crud_auth_headers, db):
        ...
        students_data = {
            "students": [
                {"name": "New Student", "birthdate": "2010-01-01", "student_id": "NEW01"},
                {"name": "Duplicate Student", "birthdate": "2010-01-01", "email": sample_student.email}  # Duplicate email
            ]
        }
...
class TestProgramCRUD:
    ...
    def test_create_program_success(self, client, sample_classroom, crud_auth_headers):
        ...
        response = client.post("/api/teachers/programs", json=program_data, headers=crud_auth_headers)
    ...
    def test_get_program_by_id(self, client, sample_program, crud_auth_headers):
        ...
        response = client.get(f"/api/teachers/programs/{sample_program.id}", headers=crud_auth_headers)
    ...
    def test_update_program(self, client, sample_program, crud_auth_headers):
        ...
        response = client.put(f"/api/teachers/programs/{sample_program.id}", json=update_data, headers=crud_auth_headers)
    ...
    def test_delete_program(self, client, sample_program, crud_auth_headers):
        ...
        response = client.delete(f"/api/teachers/programs/{sample_program.id}", headers=crud_auth_headers)
        
        assert response.status_code == 200
        
        # Verify program is marked inactive
        get_response = client.get(f"/api/teachers/programs/{sample_program.id}", headers=crud_auth_headers)
        assert get_response.status_code == 404
...
class TestErrorHandling:
    ...
    def test_invalid_data_handling(self, client, crud_auth_headers):
        ...
        invalid_data_tests = [
            ...
            ("POST", "/api/teachers/programs", {"name": "Test"}),  # Missing required fields
        ]
