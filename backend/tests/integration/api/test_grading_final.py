        ...
        try:
            ...
            if assignments_section.is_visible():
                ...
                if assignment_link.is_visible():
                    ...
                    # 6. 現在應該在作業詳情頁，尋找批改按鈕
                    page.screenshot(
                        path="/Users/young/project/duotopia/tmp/assignment_detail_page.png"
                    )
                    ...
                    if count > 0:
                        ...
                        if modal.is_visible():
                            ...
                            # 截圖
                            page.screenshot(
                                path="/Users/young/project/duotopia/tmp/grading_modal_success.png"
                            )
            ...
            print(f"❌ 測試失敗: {e}")
            page.screenshot(
                path="/Users/young/project/duotopia/tmp/test_error_final.png"
            )
