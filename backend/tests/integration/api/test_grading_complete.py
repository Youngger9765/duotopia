        ...
        try:
            ...
            if button_count > 0:
                ...
                if modal.is_visible():
                    ...
                    # 截圖
                    page.screenshot(
                        path="/Users/young/project/duotopia/tmp/grading_modal_opened.png"
                    )
                    ...
                    time.sleep(1)
                    page.screenshot(
                        path="/Users/young/project/duotopia/tmp/grading_modal_filled.png"
                    )
                    ...
                    print("❌ Modal 未開啟")
                    page.screenshot(
                        path="/Users/young/project/duotopia/tmp/grading_modal_error.png"
                    )
            else:
                print("❌ 頁面上沒有批改按鈕")
                page.screenshot(
                    path="/Users/young/project/duotopia/tmp/no_grade_button.png"
                )
