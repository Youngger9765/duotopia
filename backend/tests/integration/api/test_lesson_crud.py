...
def test_lesson_crud():
    ...
    response = requests.get(
        f"{BASE_URL}/teachers/programs/{program_id}/lessons", headers=headers
    )
    ...
    for lesson in lessons:
        response = requests.get(
            f"{BASE_URL}/teachers/lessons/{lesson['id']}/contents", headers=headers
        )
        ...
        if contents:
            ...
            response = requests.delete(
                f"{BASE_URL}/teachers/lessons/{lesson['id']}", headers=headers
            )
