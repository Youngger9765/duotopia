...
class TeacherCRUDTest:
    ...
    def test_student_crud(self):
        ...
        batch_students = [
            {"name": "批次學生1", "email": "batch1@duotopia.com", "birthdate": "2012-06-01"},
            {"name": "批次學生2", "email": "batch2@duotopia.com", "birthdate": "2012-06-02"},
            {"name": "批次學生3", "email": "batch3@duotopia.com", "birthdate": "2012-06-03"}
        ]
        response = requests.post(
