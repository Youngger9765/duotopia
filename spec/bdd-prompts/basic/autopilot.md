...
這是 Autopilot 的核心階段，與 [`clarify-and-translation.md`](./clarify-and-translation.md) 的差異在於**自動決策而非互動式詢問**。

### 3.1 初始化載入

與 `clarify-and-translation.md` 相同：
...
**與 `clarify-and-translation.md` 的關鍵差異：不詢問用戶，直接進行情境推斷決策。**
...
### 3.4 立即整合（與 clarify-and-translation.md 相同）
...
### 3.6 驗證（與 clarify-and-translation.md 相同）
...
### 與 Clarify-and-Translation.md 的整合
