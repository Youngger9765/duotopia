...
STUDENTS = [
    {"name": "王小明", "email": "student1@duotopia.com", "password": "mynewpassword123", "classroom_id": 1},
    {"name": "李小美", "email": "student2@duotopia.com", "password": "20120101", "classroom_id": 1},
    {"name": "陳大雄", "email": "student3@duotopia.com", "password": "student456", "classroom_id": 1},
    {"name": "張志豪", "email": "student4@duotopia.com", "password": "20120101", "classroom_id": 2},
    {"name": "林靜香", "email": "student5@duotopia.com", "password": "password789", "classroom_id": 2},
]
...
class TestStudentAPI:
    ...
    def test_student_login(self, student_name: str, email: str, password: str, classroom_id: int) -> Dict[str, Any]:
        """測試學生登入"""
    ...
    def test_get_assignments(self) -> list:
        ...
        response = requests.get(
            f"{self.base_url}/api/students/assignments",
    ...
    def test_student_profile(self) -> Dict[str, Any]:
        ...
        response = requests.get(
            f"{self.base_url}/api/students/profile",
            headers=self.headers
        )
